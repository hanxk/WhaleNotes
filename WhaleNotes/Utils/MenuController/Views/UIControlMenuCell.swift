...
class UIControlMenuCell:UITableViewCell {
    ...
    private func setupData(parameters:Parameters?, animated:Bool) {
        ...
        iconImageView.image = parameters?.image.withTintColor(MenuConfig.cellColor).withRenderingMode(.alwaysOriginal)
    }
...
//        contentView.backgroundColor = MenuConfig.cellBg
    ...
    private lazy var titleLabel:UILabel = {
        ...
        label.textColor = MenuConfig.cellColor

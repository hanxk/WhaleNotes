...
class UIControlMenuView: UIView {
    ...
    lazy var tableView : UITableView = {
        ...
        tv.backgroundColor = MenuConfig.bg
        tv.bounces = true
    ...
    lazy var cancelButton:UIButton = {
        ...
        let image = UIImage(systemName: "multiply.circle.fill", withConfiguration: UIImage.SymbolConfiguration(textStyle: .title3))! .withRenderingMode(.alwaysTemplate)
        button.setImage(image, for: .normal)
        button.tintColor = UIColor(hexString: "#828186").withAlphaComponent(0.6)
